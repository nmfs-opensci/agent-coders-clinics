# LiteLLM gateway: history and superseded decisions

Chronological record of how the gateway got built (issue #1). Much of it is
superseded (accounts abandoned, instances rebuilt); kept for the reasoning.
Current facts are in `litellm-gateway.md`; read that first.
